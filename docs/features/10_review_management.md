## 10-1.注文評価確認機能
### 注文評価確認機能
　この章では、管理者ユーザーが一般ユーザーの登録した商品評価を確認できる機能<br>
　期間絞り込み、スター評価、レビュー内容の確認を扱う<br>

- [注文評価確認画面](#注文評価確認画面)
- [管理者用評価一覧の取得](#管理者用評価一覧の取得)
- [期間での絞り込み](#期間での絞り込み)
- [注文評価カードの表示](#注文評価カードの表示)
- [注文評価確認で使う主なデータ](#注文評価確認で使う主なデータ)
- [注文評価確認機能のまとめ](#注文評価確認機能のまとめ)

### 注文評価確認画面
注文評価確認画面では、管理者ユーザーが全ユーザーの商品評価を一覧で確認する<br>
...
　　スター評価とレビューを表示する<br><br>

- ここで確認すること<br>
　注文評価確認画面は管理者ユーザーだけが表示できる<br>
　一般ユーザー側の注文評価登録画面とは役割が異なる<br><br>
...
- ここで確認すること<br>
　GET /api/reviewsはログイン中ユーザーの評価だけを返す<br>
　GET /api/admin/reviewsは全ユーザーの評価を対象にする<br><br>
...
　　monthの場合は直近1ヶ月の評価を取得する<br><br>

- ここで確認すること<br>
　期間を変更したタイミングでAPIを再実行する<br>
　対象期間の評価がない場合は空メッセージを表示する<br>
　対象期間の評価がない場合は「対象期間の評価はありません。」と表示する（期間での絞り込み 練習問題10-1-1-1）<br><br>
...
### 注文評価カードの表示
注文評価カードの表示では、管理者が確認しやすい形でレビュー情報を表示する<br>
...
　　お客様からのレビューを表示する<br>
　　レビューが未入力の場合は「レビューコメントは入力されていません。」と表示する<br><br>

- ここで確認すること<br>
　スター評価の表示には共通部品のRatingStarsを使用する<br>
　レビュー本文は「お客様からのレビュー」として分かるように表示する<br>
　評価登録日時はユーザー名の下に表示する（注文評価カードの表示 練習問題10-1-2-1）<br><br>
