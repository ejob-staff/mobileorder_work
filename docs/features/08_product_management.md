...
　　商品登録、商品編集、公開状態変更、商品削除の操作を表示する<br>

- ここで確認すること<br>
　商品管理画面は管理者ユーザーだけが表示できる<br>
　管理者側では公開中、非公開の両方の商品を取得する<br>
...
　　注文数、平均評価、IDの順で並び替える<br>

- ここで確認すること<br>
　一般ユーザー用のGET /api/productsは公開中の商品だけを返す<br>
　管理者用のGET /api/admin/productsは非公開の商品も含めて返す<br>
...
　検索結果がない場合とカテゴリ内商品がない場合で表示文言を切り替えている<br>
...
- ここで確認すること<br>
　登録完了後は商品管理画面へ戻る<br>
　ProductFormPageは登録と編集で共通利用している<br>
...
　価格と在庫数はReact側でNumberに変換して送信する<br>
...
- ここで確認すること<br>
　削除前には「商品情報テーブルに登録されている商品ですが、本当に削除してもよろしいでしょうか。」で確認する<br>
