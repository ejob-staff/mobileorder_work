...
　価格と在庫数の初期値は0にする（商品登録画面 練習問題8-1-14-1）<br>
　公開状態の入力は「公開にする」「非公開にする」のラジオボタンにする（商品登録画面 練習問題8-1-14-1）<br><br>
...
　ボタンの横に「公開設定の変更」という見出しを表示する（公開状態の切り替え 練習問題8-1-11-1）<br>
　確認モーダルは「公開にする」ボタン押下時だけconfirmVariantをdangerにする（公開状態の切り替え 練習問題8-1-11-1）<br><br>
...
　`ProductService`<br>
　　商品IDで商品を削除する<br>
　　存在しない商品IDの場合はエラーになっている（追加実装4）<br><br>
