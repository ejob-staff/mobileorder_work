...
　画面上では100点満点のスコアとして表示する<br>
　全体スコアに応じて店舗コンディションの文言を切り替える（総合インサイト 練習問題11-1-1-1）<br><br>
...
- ここで確認すること<br>
　売上がない日も0として表示する<br>
　グラフの各点にその日の売上金額が分かる表示を加える（日付別の売上推移 練習問題11-1-2-1）<br><br>
...
　表示する指標は5種類である<br>
　ペンタゴンの各頂点には指標名のラベルを添えて表示する（カテゴリ別バランス 練習問題11-1-3-1）<br><br>
