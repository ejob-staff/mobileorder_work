...
　戻り先のURLとボタン文言はpropsとして受け取って表示する（権限エラー画面 練習問題3-1-7-1）<br>
　管理者ユーザーがアカウント管理画面のURLへアクセスした場合も権限エラー画面を表示する（権限エラー画面 練習問題3-1-7-2）<br>
　エラー文言の文字色を指定する（権限エラー画面 練習問題3-1-7-3）<br><br>
...
　ログイン中ユーザー名は管理者と一般ユーザーで文字色を分けて表示する（共通ヘッダー 練習問題3-1-9-1）<br><br>
...
　/api/accountは一般ユーザーだけが利用できるようにする（SpringSecurityの基本設定 練習問題3-1-13-1）<br><br>
...
### 注意事項
　練習問題は難しいと感じた場合は無理に解答せずに、飛ばして次に進んで頂いて問題ありません。<br>
　エラーが発生した場合は変更前の状態に戻してから進めて頂いて大丈夫です。<br>
